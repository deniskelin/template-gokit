...
import (
	...
	"github.com/deniskelin/billing-gokit/internal/debugcharts/static_web"
...
func makeHandler() http.Handler {
	...
	r.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(200)
		w.Write(static_web.IndexHTMLPage)
	})

	r.Get("/static/*", func(w http.ResponseWriter, r *http.Request) {
		rctx := chi.RouteContext(r.Context())
		if rctx != nil {
			err := tryRead(static_web.StaticFiles, "", strings.Replace(rctx.RoutePath, "/", "", 1), w)
			if err == nil {
				return
			}
		}
	})
	r.HandleFunc("/data-feed", s.dataFeedHandler)
